...
export class ColumnBuilder {
  ...
  public notNullable(): this {
    this.def.isNullable = false;
    return this;
  }
  public nullable(): this {
    this.def.isNullable = true;
    return this;
  }
  public unique(): this {
  ...
  public defaultToNow(): this {
    this.def.defaultValue = 'CURRENT_TIMESTAMP';
    return this;
  }
}
...
export class TableBuilder {
  ...
  public increments(name = 'id'): ColumnBuilder {
    return this.col(name, 'INTEGER', false, true, true);
  }
  public string(name: string, length = 255): ColumnBuilder {
    return this.col(name, `VARCHAR(${length})`);
  }
  public integer(name: string): ColumnBuilder {
    return this.col(name, 'INTEGER');
  }
  public decimal(name: string, precision = 10, scale = 2): ColumnBuilder {
    return this.col(name, `DECIMAL(${precision}, ${scale})`);
  }
  public boolean(name: string): ColumnBuilder {
    return this.col(name, 'BOOLEAN');
  }
  public text(name: string): ColumnBuilder {
    return this.col(name, 'TEXT', true);
  }
  public timestamp(name: string): ColumnBuilder {
    return this.col(name, 'TIMESTAMP', true);
  }
  public uuid(name: string): ColumnBuilder {
    return this.col(name, 'UUID');
  }
  public json(name: string): ColumnBuilder {
    return this.col(name, 'JSON', true);
  }
  public float(name: string, precision = 8, scale = 2): ColumnBuilder {
    return this.col(name, `FLOAT(${precision}, ${scale})`);
  }
